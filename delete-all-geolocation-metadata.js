...
// Function to delete all metadata for collection 1
async function deleteAllMetadata() {
  console.log('🗑️  Starting deletion of all metadata for collection 1...\n');
...
if (require.main === module) {
  deleteAllMetadata().catch(console.error);
}

module.exports = { deleteAllMetadata, getAllMetadata, deleteMetadata };
